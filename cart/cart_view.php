...
<body>
    ...
    <script>
    fetch('cart_api.php?action=fetch')
        ...
        if (form) {
          ...
          form.querySelectorAll(".qtyInput").forEach((input, idx) => {
            input.addEventListener("input", function(e) {
              ...
              fetch(`cart_api.php?action=update&product_id=${productId}&quantity=${qty}`)
                .then(res => res.json())
                .then(resp => {
                  if (!resp.success) {
          ...
          container.addEventListener('click', function(e) {
            if (e.target.classList.contains('deleteBtn')) {
              ...
              fetch(`cart_api.php?action=remove&product_id=${productId}`)
                .then(res => res.json())
                .then(resp => {
          ...
          document.getElementById('checkoutBtn').addEventListener('click', function() {
            ...
            fetch('/Wad_assignment/order/index.php', {
              method: 'POST',
